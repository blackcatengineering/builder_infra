...
module "storage-classes" {
  source      = "https://github.com/orgs/blackcatengineering/tf-mod-storage-classes"
...
module "builder-istio" {
  ...
  source        = "https://github.com/orgs/blackcatengineering/tf-mod-istio"
...
module "builder-jenkins" {
  count       = (var.enable_istio) ? 1 : 0
  source      = "https://github.com/orgs/blackcatengineering/tf-mod-jenkins"
  k8s_cluster = openstack_containerinfra_cluster_v1.cluster_1.name
  # domain  = "example.com"
  providers = {
    helm       = helm.helm_config
...
module "builder-ip-masq" {
  ...
  source      = "https://github.com/orgs/blackcatengineering/tf-mod-ip-masq-agent"
  k8s_cluster = openstack_containerinfra_cluster_v1.cluster_1.name
  # domain  = "example.com"
  providers = {
    kubernetes = kubernetes.kubernetes_config
...
module "harness" {
  ...
  source = "https://github.com/orgs/blackcatengineering/tf-mod-harness"
  providers = {
    helm       = helm.helm_config
    kubernetes = kubernetes.kubernetes_config
  }
...
module "cert-manager" {
  ...
  source = "https://github.com/orgs/blackcatengineering/tf-mod-cert-manager"
  providers = {
    helm       = helm.helm_config
    kubernetes = kubernetes.kubernetes_config
  }
...
module "jaeger" {
  ...
  source = "https://github.com/orgs/blackcatengineering/tf-mod-jaeger"
  providers = {
    helm       = helm.helm_config
    kubernetes = kubernetes.kubernetes_config
  }
